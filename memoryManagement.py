...
d=1000000000 
print(id(d)) #Here This will likely return the same memory address as id(c) because Python may optimize memory usage by reusing the same object for identical immutable values, even if they are larger integers. However, this behavior can vary based on the implementation and version of Python being used.
